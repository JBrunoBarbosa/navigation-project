...
class BottomFourFragment : Fragment() {
    ...
    private lateinit var binding: FragmentAddBottomFourBinding
    ...
    private fun setUpViewBinding() {
        binding = FragmentAddBottomFourBinding.inflate(layoutInflater)
    }
    ...
    private fun setUpClicksListeners() {
        binding.apply {
            ...
            btnNext.setOnClickListener {
                view?.let { view ->
                    Navigation.findNavController(view).navigate(R.id.navigate_to_main)
                }
            }
